...
namespace DAM
{
    public class FLGameData
    {
            ...
            if (vDLLs.Count > iDLL)
            {
                ...
                if (hInstance != IntPtr.Zero)
                {
                    ...
                    if (len > 0)
                    {
                        ...
                        byte[] asciiBytes = Encoding.Convert(windows1251, Unicode, bufName);
        ...
        public static void ReplaceInFile(string filePath, string searchText, string replaceText)
        {
            ...
            streamReader.Close();
            text = Regex.Replace(text, searchText, replaceText, RegexOptions.IgnoreCase | RegexOptions.Singleline);
